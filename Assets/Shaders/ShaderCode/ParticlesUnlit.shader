Shader "Custom/ParticlesUnlit"
{
    Properties
    {
        ...
        _IsSingleChannel("IsSingleChannel", Float) = 0.0
        ...
        _BlendMapUVScroll("BlendMap UV Scroll", Vector) = (0,0,0,0)
        ...
        _DissSmooth("DissSmooth", Range(0.001,0.5)) = 0.5
        ...
        SubShader
        {
            ...
            #pragma shader_feature _SINGLE_CHANNEL
