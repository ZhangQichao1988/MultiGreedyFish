...
public class EnemyBase : FishBase
{
    ...
    {
        return Quaternion.AngleAxis(Wrapper.GetRandom(0f, 360f), Vector3.up) * Vector3.right * Wrapper.GetRandom(0f, BattleManagerGroup.GetInstance().poisonRing.GetSafeRudius() - 5f);
    }
