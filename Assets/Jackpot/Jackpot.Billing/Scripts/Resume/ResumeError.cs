...
{
    public class ResumeError
    {
        /// <summary>
        /// リジューム処理のリクエストが失敗したことを示します
        /// </summary>
        ...
        public static ResumeError FailedOnPlatformRequest(string message)
        {
            var result = new ResumeError(message);
            result.IsFailedOnPlatformRequest = true;
            return result;
        }

        ResumeError(string message)
        {
            Message = message;
        }
    }
