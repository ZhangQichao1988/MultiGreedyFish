...
CREATE TABLE `RobotData`(`ID` INT(11),`fishId` INT(11),`name` TEXT,`aiId` INT(11),PRIMARY KEY (`ID`))ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
INSERT INTO `RobotData`(`ID`,`fishId`,`name`,`aiId`) VALUES (0.0,1.0,'阿超',1),(1.0,1.0,'Ferya',1),(2.0,1.0,'HUSKY',1),(3.0,1.0,'DIAMOND DRAGON',0),(4.0,1.0,'Mr.L  - Jiayin',0),(5.0,1.0,'Asura',0),(6.0,1.0,'睡在梦里，醒在梦境',0),(7.0,1.0,'Rebecca',2),(8.0,1.0,'༄༠་Yོiིnྀgོ་༠࿐',2),(9.0,2.0,'Boss',3);
