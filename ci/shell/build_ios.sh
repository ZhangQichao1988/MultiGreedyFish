...
if [[ ${BUILD_TYPE} == "adhoc" ]]; then
    ...
    MOBILE_PROVISION_UUID=${MOBILE_PROVISION_UUID:-392c8d99-9c1d-47d4-b4da-7b495e9d29fd}
    ...
    IS_DEVELOPMENT="true"
    DEV_TEAM=${DEV_TEAM:-LQ497AGR75}
    MOBILE_PROVISION_UUID=${MOBILE_PROVISION_UUID:-b7a1c8e1-b024-4d3a-9287-4137b3d79210}
...
echo ${WORKDIR}
UNITY_PATH=/Applications/Unity/Hub/Editor/2019.4.14f1c1/Unity.app/Contents/MacOS/Unity
