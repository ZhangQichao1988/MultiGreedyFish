...
base_data_type = {
    ...
    "FishData": sort_cloum_item(
        ["ID", "INT(11)", "name", "INT(11)", "prefabPath", "TEXT", "atk", "INT(11)", "life", "INT(11)",
         "moveSpeed", "DOUBLE(16,2)", "skillId", "INT(11)", "rare", "INT(11)", "isPlayerFish", "INT(11)"]),
    ...
    "ShopBillingItem": sort_cloum_item(
        ["ID", "INT(11)", "type", "TEXT", "resIcon", "TEXT", "refresh", "TEXT", "price", "INT(11)", "platformId", "TEXT", "productContent", "TEXT", "beginAt", "TEXT", "endAt", "TEXT", "limitAmount", "INT(11)",  "rate", "INT(11)"]),
